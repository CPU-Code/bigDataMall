...
- [x] [新增交易用户统计](ads_mysql/ads_new_buyer_stats.sql)
- [x] [各省份订单统计](ads_mysql/ads_order_by_province.sql)
- [x] [用户路径分析](ads_mysql/ads_page_path.sql)
- [x] [各品牌复购率](ads_mysql/ads_repeat_purchase_by_tm.sql)
- [x] [各品类商品购物车存量topN](ads_mysql/ads_sku_cart_num_top3_by_cate.sql)
- [x] [交易综合统计](ads_mysql/ads_trade_stats.sql)
...
- [x] [支付方式表](lg_mall/dim/dim_trade_shops_org.sql)
