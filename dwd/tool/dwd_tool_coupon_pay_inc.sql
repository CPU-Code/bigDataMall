...
insert overwrite table dwd_tool_coupon_order_inc
    partition (dt)
select data.id,
       data.coupon_id,
       data.user_id,
...
insert overwrite table dwd_tool_coupon_pay_inc
...
show partitions dwd_tool_coupon_order_inc;
...
select id,
       ...
       payment_time,
       dt
from dwd_tool_coupon_order_inc
where dt = '2020-06-14';
