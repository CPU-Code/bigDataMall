...
insert overwrite table dwd_traffic_display_inc
...
from (
         select common.ar         area_code,
                ...
                ts
         from ods_log_inc lateral view expload(displays) tem as display
         where dt = '2020-06-14'
...
show partitions dwd_traffic_display_inc;
